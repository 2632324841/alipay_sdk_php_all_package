...
use aop\Aoprequest\AlipayTradeQueryRequest;
use aop\Aoprequest\AlipayTradeWapPayRequest;
use aop\Aoprequest\AlipayTradeAppPayRequest;
/**
...
$request = new \aop\request\AlipayTradeAppPayRequest ();
$request->setBizContent("{" .
    "\"timeout_express\":\"90m\"," .
    "\"total_amount\":\"9.00\"," .
